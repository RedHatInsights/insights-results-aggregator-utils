...
optional arguments:
  ...
  -e EXPORT, --export EXPORT
                        Name of CSV or XLSX file with exported comparison results
  -s, --xlsx            Use XLSX output instead of CSV output for exported
                        comparison results
  -d, --additional-info
...
def compare_results(directory1, directory2, filename, xlsx_output, info, verbose):
